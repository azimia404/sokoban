...
#include "levels.h"
    ...
    void LevelController::load_next_level() {
        ++level_index;
    ...
    bool LevelController::is_cell_inside_level(int row, int column) {
    ...
    void LevelController::set_level_cell(size_t row, size_t column, char cell) {
